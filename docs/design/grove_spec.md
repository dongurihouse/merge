...
The five maps below are **the home grove** — the first maps in the §1 story (**the only structural unit is the map**, Core §8 — no episode/chapter tier). The **count is a tuning call**, not canon — more maps, and further places, are expected (§1). Current scaffold — **five maps, 8 spots each, each spot 3–5★** (all spots **unlock-once**: Stars + level, ruined→restored, no second coin-upgrade axis):
