...
| **Coins 🪙 (acorns)** | merge drops (~10%) · selling t1–t7 · **quest-overflow** (§4) · Shop **5💎→150🪙** | **[Superseded — see `residents_spec.md`: residents now carry an economic role + capacity.]** **welcoming base residents on completed maps** (§3 — the primary, *endless* coin sink) · **generator burst** (§2) · waysides · spirit treats · basket buy-back |
