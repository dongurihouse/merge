...
```bash
make sw SCENE=fairy_hollow ROOT=/Users/xup/dh/merge/.worktrees/codex-fairy-hollow-original-mock-v4/games/grove/assets/_concepts/zones
```

Save in the workbench, then regenerate deterministic review output:

```bash
python3 games/grove/assets/_concepts/zones/fairy_hollow_elements_v4/09_reconstruction/compose_reconstruction.py
python3 games/grove/assets/_concepts/zones/fairy_hollow_elements_v4/09_reconstruction/compose_reconstruction.py --validate-only
```
