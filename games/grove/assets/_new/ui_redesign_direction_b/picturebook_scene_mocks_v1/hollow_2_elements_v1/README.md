# Hollow 2 — editable scene bundle
...
separate assets rather than a flattened zone mock. It is a distinct editable scene from the
existing Fairy Hollow bundle.
...
```bash
make sw SCENE=hollow_2 ROOT=/Users/xup/dh/merge/games/grove/assets/_new/ui_redesign_direction_b/picturebook_scene_mocks_v1
```

Save in the workbench, then regenerate deterministic review output:

```bash
python3 games/grove/assets/_new/ui_redesign_direction_b/picturebook_scene_mocks_v1/hollow_2_elements_v1/09_reconstruction/compose_reconstruction.py
python3 games/grove/assets/_new/ui_redesign_direction_b/picturebook_scene_mocks_v1/hollow_2_elements_v1/09_reconstruction/compose_reconstruction.py --validate-only
```
