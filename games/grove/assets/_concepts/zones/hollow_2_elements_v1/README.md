...
```bash
make sw SCENE=hollow_2 ROOT=/Users/xup/dh/merge/games/grove/assets/_concepts/zones
```

Save in the workbench, then regenerate deterministic review output:

```bash
python3 games/grove/assets/_concepts/zones/hollow_2_elements_v1/09_reconstruction/compose_reconstruction.py
python3 games/grove/assets/_concepts/zones/hollow_2_elements_v1/09_reconstruction/compose_reconstruction.py --validate-only
```
