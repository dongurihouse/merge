extends SceneTree
## Launch Feel workbench — standalone runner.
##   live:             make launch-workbench
##   quiet screenshot: make shot-launch-workbench [OUT=/tmp/launch_workbench.png]

const UiFont = preload("res://engine/scripts/ui/ui_font.gd")
const VIEW := "res://games/grove/tools/launch_workbench_view.gd"
...
func _initialize() -> void:
	...
	if quiet:
		...
		var out: String = String(ua[0]) if ua.size() >= 1 else "/tmp/launch_workbench.png"
