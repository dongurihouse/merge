extends SceneTree
## Land Feel workbench — standalone runner.
##   live:             make land-workbench
##   quiet screenshot: make shot-land-workbench [OUT=/tmp/land_workbench.png]

const UiFont = preload("res://engine/scripts/ui/ui_font.gd")
const VIEW := "res://games/grove/tools/land_workbench_view.gd"
...
func _initialize() -> void:
	...
	if quiet:
		...
		var out: String = String(ua[0]) if ua.size() >= 1 else "/tmp/land_workbench.png"
