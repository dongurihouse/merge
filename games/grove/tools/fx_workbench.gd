extends SceneTree
## FX Workbench - standalone runner for the Grove reward/motion lab.
##   live:             make fx-workbench
##   quiet screenshot: make shot-fx-workbench [OUT=/tmp/fx_workbench.png]
...
func _initialize() -> void:
	...
	var win := Vector2i(1840, 1040)
	if screen.x > 0 and screen.y > 0:
		win.x = mini(1840, screen.x - 80)
