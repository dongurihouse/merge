extends SceneTree
## Merge Feel workbench — standalone runner.
##   live:             make merge-workbench
##   quiet screenshot: make shot-merge-workbench [OUT=/tmp/merge_workbench.png]

const UiFont = preload("res://engine/scripts/ui/ui_font.gd")
const VIEW := "res://games/grove/tools/merge_workbench_view.gd"
...
func _initialize() -> void:
	...
	if quiet:
		...
		var out: String = String(ua[0]) if ua.size() >= 1 else "/tmp/merge_workbench.png"
