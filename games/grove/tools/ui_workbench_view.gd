...
const IDS := ["button", "home_button", "icon", "badge", "card", "daily_card", "tiers_card", "toggle_card", "frame", "dialog", "daily", "shop", "tiers", "currency_pill", "settings", "vault"]
...
const COLUMNS := [
	...
	[["dialog"], ["daily"], ["shop"], ["tiers"], ["currency_pill"], ["settings"], ["vault"]],   # dialogs, the HUD wallet pill, settings, vault
]
