...
const IDS := ["button", "home_button", "icon", "badge", "card", "daily_card", "tiers_card", "toggle_card", "map_card", "frame", "dialog", "daily", "shop", "tiers", "currency_pill", "settings"]
...
const COLUMNS := [
	[["home_button"], ["button", "icon", "badge"], ["card"], ["daily_card"], ["tiers_card", "toggle_card"], ["map_card"], ["frame"]],   # the building blocks
