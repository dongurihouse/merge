...
func _test_rush_intro_hint() -> void:
	...
	ok(replay_style != null and replay_style.shadow_color.is_equal_approx(Color("#294654", replay_style.shadow_color.a)) \
		and absf(replay_style.shadow_color.a - 0.38) <= 0.01, \
		"the live Rush info button casts THE uniform slate shadow")
