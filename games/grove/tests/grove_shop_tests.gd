...
func _initialize() -> void:
	...
	# T-J: the live board surfaces the empty-water stack — the free/💎 refill + the offer button
	...
	if bw.board == null:
		bw._ready()
	ok(bw.refill_btn != null and bw.oow_offer_btn != null, "the board builds the refill + offer surfaces")
