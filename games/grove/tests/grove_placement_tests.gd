...
func _initialize() -> void:
	...
	# --- order T (T43): live-IAP ladder + starter + first-buy doubler + free claims. §4 law:
	# --- premium buys SPEED + LOOKS, never POSSIBILITY — every wall is free-passable
	# --- (slower); claims are capped+cooled.
