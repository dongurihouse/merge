...
class Hud:
	...
	const PILL_SHADOW := Color(0, 0, 0, 0.2)
	const PILL_SHADOW_SIZE := 6
...
class UiSkin:                             # NOT "Skin" — that's a native Godot class
	...
	const PARCH_SHADOW := Color(0, 0, 0, 0.2)
	const PARCH_SHADOW_SIZE := 6
	...
	const TITLE_SHADOW := Color(0, 0, 0, 0.2)
	const TITLE_SHADOW_SIZE := 6
	...
	const BTN_SHADOW := Color(0, 0, 0, 0.2)
	const BTN_SHADOW_SIZE := 6
	const BTN_SHADOW_OFFSET := Vector2(0, 5)
	...
	const SHADOW_RESTING := Color(0, 0, 0, 0.2)         # THE uniform shadow (neutral black, 0.28 — dims any ground like the mocks)
	const SHADOW_RESTING_SIZE := 6
	const SHADOW_RESTING_OFFSET := Vector2(0, 5)
	const SHADOW_RAISED := Color(0, 0, 0, 0.2)          # same as Resting — one shadow, no tiers
	const SHADOW_RAISED_SIZE := 6
...
class Shop:
	...
	const BUY_SHADOW := Color(0, 0, 0, 0.2)
	const BUY_SHADOW_SIZE := 6
	const BUY_SHADOW_OFFSET := Vector2(0, 5)
	...
	const CARD_SHADOW := Color(0, 0, 0, 0.2)
