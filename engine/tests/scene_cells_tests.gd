...
func _test_derived_cluster_floors() -> void:
	...
	ok(floors == [1, 6, 12, 17, 23, 28, 29, 32, 35, 38, 41, 42, 45, 48, 51, 54, 55, 57, 60, 62, 64, 65, 67, 69, 71],
	...
	ok(Content.scene_level_window(0) == Vector2i(1, 28), "Fairy Hollow spans L1-28")
	ok(Content.scene_level_window(1) == Vector2i(29, 41), "Snowy Village spans L29-41")
	ok(Content.scene_level_window(2) == Vector2i(42, 54), "Desert Oasis spans L42-54")
	ok(Content.scene_level_window(3) == Vector2i(55, 64), "Coral Reef spans L55-64")
	ok(Content.scene_level_window(4) == Vector2i(65, 71), "Cherry Blossom spans L65-71")
