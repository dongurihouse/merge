...
`Makefile`: `grove_board_actions_tests`, `grove_explore_tests`, `grove_sky_tests`, `grove_scene_workbench_tests`, `grove_scene_covers_tests`, `grove_shop_tests`, `grove_ui_workbench_tests`, `grove_ftue_tests`, `grove_rush_ftue_tests`.
