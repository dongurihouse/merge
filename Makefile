...
ENGINE_TESTS := engine/tests/save_tests engine/tests/mechanics_tests engine/tests/quest_tests engine/tests/quest_fence_tests engine/tests/anchor_tests engine/tests/layering_tests engine/tests/inbox_sync_tests engine/tests/identity_tests engine/tests/store_tests engine/tests/iap_tests engine/tests/scene_warm_tests engine/tests/kit_config_cache_tests engine/tests/kit_polish_async_tests engine/tests/kit_bake_tests engine/tests/boot_trace_tests engine/tests/map_canvas_tests engine/tests/strings_tests engine/tests/level_badge_tests engine/tests/fx_juice_tests engine/tests/vase_water_effect_tests engine/tests/debug_overlay_tests engine/tests/sfx_tests engine/tests/reward_arrival_tests engine/tests/board_hud_layout_tests engine/tests/rush_fx_tests engine/tests/feel_tests engine/tests/quest_ready_glow_tests
