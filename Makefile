...
ENGINE_TESTS := engine/tests/save_tests engine/tests/mechanics_tests engine/tests/cascade_tests engine/tests/quest_tests engine/tests/quest_fence_tests engine/tests/sky_tests engine/tests/layering_tests engine/tests/inbox_sync_tests engine/tests/identity_tests engine/tests/build_info_tests engine/tests/store_tests engine/tests/iap_tests engine/tests/scene_warm_tests engine/tests/kit_config_cache_tests engine/tests/kit_bake_freshness_tests engine/tests/boot_trace_tests engine/tests/strings_tests engine/tests/bust_tests engine/tests/tuning_tests engine/tests/resident_bucket_tests engine/tests/bucket_adapter_tests engine/tests/scene_cells_tests engine/tests/hint_tests engine/tests/action_button_tests engine/tests/unlock_bar_paper_tests engine/tests/fx_flight_tests engine/tests/ftue_hand_hint_tests engine/tests/update_check_tests engine/tests/asset_size_guard_tests engine/tests/cluster_manifest_tests engine/tests/palette_ssot_tests engine/tests/modal_dismiss_tests engine/tests/resident_drag_tests engine/tests/suite_registry_tests engine/tests/fx_config_tests engine/tests/const_ssot_tests engine/tests/feature_flag_registry_tests engine/tests/save_migrate_tests engine/tests/mastery_tests engine/tests/improvements_tests engine/tests/hud_paper_tests engine/tests/smooth_paper_tests engine/tests/cascade_marks_tests engine/tests/level_badge_medal_tests
...
.PHONY: help run g g-phone debug editor w fx test test-fast test-config test-engine test-grove test-one smoke import bake bake-textures \
        shot-map shot-grove shot-widget shot-mock shot shot-batch shot-workbench shot-fx-workbench sw shot-sw \
