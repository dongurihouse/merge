...
GROVE_TESTS  := games/grove/tests/grove_workbench_tests
...
bake-textures: ## pre-bake the runtime defringe/feather polish (games/tools/bake_textures.json) so dialogs open without the first-use hitch
